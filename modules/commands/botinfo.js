...
"https://4.bp.blogspot.com/-yAExPAr7JeA/WDaBRVuJwxI/AAAAAAALb7I/Dbvda0KD5uECF3_SBjsvkl2_mqP9_BweQCLcB/s1600/AS000834_17.gif",
  ...
  var callback = () => api.sendMessage({body:`梁 BOT INFO梁
  chào cậu, đây là một chú bot tự do (p≧w≦q)
...
- Nếu bot ko hoạt động hay bị lỗi hay /callad liên hệ qua mess để được liên hệ trực tiếp với mình
=> Yêu mọi người nhiều lắm <3 hãy đồng hành cùng với bot và mình nhé <3

----KAM----`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
